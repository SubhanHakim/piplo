            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center p-4 md:p-6 w-full max-w-4xl">
                ...
                <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="flex items-center gap-6 mt-2">
                        {/* X (Twitter) */}
                        <a href="https://twitter.com" target="_blank" rel="noreferrer" className="group p-3 bg-black/50 rounded-xl border border-white/10 hover:bg-black hover:border-white/50 transition-all hover:-translate-y-1">
                        ...
                        {/* Dexscreener */}
                        <a href="https://dexscreener.com" target="_blank" rel="noreferrer" className="group p-3 bg-black/50 rounded-xl border border-white/10 hover:bg-black hover:border-white/50 transition-all hover:-translate-y-1">
